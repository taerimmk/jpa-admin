	...
	<c:choose>
		<c:when test="${not empty sideBanner.searchVal }">
			<c:set
				...
				var="listUrl" />
			<c:set
				value="/sideBanner/set/${sideBanner.pageIndex}/${sideBanner.id}/${sideBanner.searchKey}/${sideBanner.searchVal}"
				var="setUrl" />
		</c:when>
		<c:otherwise>
			<c:set
				value="/sideBanner/set/${sideBanner.pageIndex}/${sideBanner.id}"
				var="setUrl" />
						...
						<div class="page-title">
							<h4>
								<i class="icon-arrow-left52 position-left"></i> <span
									class="text-semibold">사이드배너관리</span> - 사이드배너수정
							</h4>
						</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control maxlength"
												...
												value="${ sideBannerRes.bannername}" />
										</div>
									</div>
									<br>
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" class="touchspin-vertical" id="position"
												name="position" value="${ sideBannerRes.position}" />
										</div>
									</div>
									<br>
									<div class="form-group">
										...
										<div class="col-lg-10">
											<label class="radio-inline"> <input type="radio"
												...
												<c:if test="${'Y' eq sideBannerRes.use_at}">checked="checked"</c:if> />
												노출
											</label> <label class="radio-inline"> <input type="radio"
												class="styled" name="use_at" value="N"
												<c:if test="${'N' eq sideBannerRes.use_at}">checked="checked"</c:if> />
												비노출
											</label>
										</div>
									</div>
											...
											<div class="form-group">
												...
												<div class="media no-margin-top">
													<div class="media-left">
														<c:choose>
															<c:when test="${empty sideBannerRes.image_ko}">
																<img src="/assets/images/placeholder.jpg"
																	style="width: 52px; height: 52px; border-radius: 2px;"
																	alt="">
															</c:when>
															<c:otherwise>
																<img src="${sideBannerRes.image_ko}"
																	style="width: 52px; height: 52px; border-radius: 2px;"
																	alt="">
															</c:otherwise>
														</c:choose>
												...
												<div class="media no-margin-top">
													<input type="text" class="form-control maxlength"
														...
														value="${sideBannerRes.url_link_ko}" />
												</div>
												<br> <label class="display-block">노출여부(ko)</label> <label
													class="radio-inline"> <input type="radio"
													class="styled" name="use_at_ko" value="Y"
													<c:if test="${'Y' eq sideBannerRes.use_at_ko}">checked="checked"</c:if> />
													노출
												</label> <label class="radio-inline"> <input type="radio"
													class="styled" name="use_at_ko" value="N"
													<c:if test="${'N' eq sideBannerRes.use_at_ko}">checked="checked"</c:if> />
													비노출
												</label>
											</div>
										</div>
										<div class="col-md-2">
											<div class="form-group">
												...
												<div class="media no-margin-top">
													<div class="media-left">
														<c:choose>
															<c:when test="${empty sideBannerRes.image_en}">
																<img src="/assets/images/placeholder.jpg"
																	style="width: 52px; height: 52px; border-radius: 2px;"
																	alt="">
															</c:when>
															<c:otherwise>
																<img src="${sideBannerRes.image_en}"
																	style="width: 52px; height: 52px; border-radius: 2px;"
																	alt="">
															</c:otherwise>
														</c:choose>
												...
												<div class="media no-margin-top">
													<input type="text" class="form-control maxlength"
														...
														value="${sideBannerRes.url_link_en}" />
												</div>
												<br>
												<label class="display-block">노출여부(en)</label> <label
													class="radio-inline"> <input type="radio"
													class="styled" name="use_at_en" value="Y"
													<c:if test="${'Y' eq sideBannerRes.use_at_en}">checked="checked"</c:if> />
													노출
												</label> <label class="radio-inline"> <input type="radio"
													class="styled" name="use_at_en" value="N"
													<c:if test="${'N' eq sideBannerRes.use_at_en}">checked="checked"</c:if> />
													비노출
												</label>
											</div>
										</div>
										<div class="col-md-2">
											<div class="form-group">
												...
												<div class="media no-margin-top">
													<div class="media-left">
														<c:choose>
															<c:when test="${empty sideBannerRes.image_jp}">
																<img src="/assets/images/placeholder.jpg"
																	style="width: 52px; height: 52px; border-radius: 2px;"
																	alt="">
															</c:when>
															<c:otherwise>
																<img src="${sideBannerRes.image_jp}"
																	style="width: 52px; height: 52px; border-radius: 2px;"
																	alt="">
															</c:otherwise>
														</c:choose>
												...
												<div class="media no-margin-top">
													<input type="text" class="form-control maxlength"
														...
														value="${sideBannerRes.url_link_jp}" />
												</div>
												<br>
												<label class="display-block">노출여부(jp)</label> <label
													class="radio-inline"> <input type="radio"
													class="styled" name="use_at_jp" value="Y"
													<c:if test="${'Y' eq sideBannerRes.use_at_jp}">checked="checked"</c:if> />
													노출
												</label> <label class="radio-inline"> <input type="radio"
													class="styled" name="use_at_jp" value="N"
													<c:if test="${'N' eq sideBannerRes.use_at_jp}">checked="checked"</c:if> />
													비노출
												</label>
											</div>
										</div>
										<div class="col-md-2">
											<div class="form-group">
												...
												<div class="media no-margin-top">
													<div class="media-left">
														<c:choose>
															<c:when test="${empty sideBannerRes.image_cn}">
																<img src="/assets/images/placeholder.jpg"
																	style="width: 52px; height: 52px; border-radius: 2px;"
																	alt="">
															</c:when>
															<c:otherwise>
																<img src="${sideBannerRes.image_cn}"
																	style="width: 52px; height: 52px; border-radius: 2px;"
																	alt="">
															</c:otherwise>
														</c:choose>
												...
												<div class="media no-margin-top">
													<input type="text" class="form-control maxlength"
														...
														value="${sideBannerRes.url_link_cn}" />
												</div>
												<br>
												<label class="display-block">노출여부(cn)</label> <label
													class="radio-inline"> <input type="radio"
													class="styled" name="use_at_cn" value="Y"
													<c:if test="${'Y' eq sideBannerRes.use_at_cn}">checked="checked"</c:if> />
													노출
												</label> <label class="radio-inline"> <input type="radio"
													class="styled" name="use_at_cn" value="N"
													<c:if test="${'N' eq sideBannerRes.use_at_cn}">checked="checked"</c:if> />
													비노출
												</label>
											</div>
										</div>
										<div class="col-md-2">
											<div class="form-group">
												...
												<div class="media no-margin-top">
													<div class="media-left">
														<c:choose>
															<c:when test="${empty sideBannerRes.image_tw}">
																<img src="/assets/images/placeholder.jpg"
																	style="width: 52px; height: 52px; border-radius: 2px;"
																	alt="">
															</c:when>
															<c:otherwise>
																<img src="${sideBannerRes.image_tw}"
																	style="width: 52px; height: 52px; border-radius: 2px;"
																	alt="">
															</c:otherwise>
														</c:choose>
												...
												<div class="media no-margin-top">
													<input type="text" class="form-control maxlength"
														...
														value="${sideBannerRes.url_link_tw}" />
												</div>
												<br>
												<label class="display-block">노출여부(tw)</label> <label
													class="radio-inline"> <input type="radio"
													class="styled" name="use_at_tw" value="Y"
													<c:if test="${'Y' eq sideBannerRes.use_at_tw}">checked="checked"</c:if> />
													노출
												</label> <label class="radio-inline"> <input type="radio"
													class="styled" name="use_at_tw" value="N"
													<c:if test="${'N' eq sideBannerRes.use_at_tw}">checked="checked"</c:if> />
													비노출
												</label>
											</div>
										</div>
