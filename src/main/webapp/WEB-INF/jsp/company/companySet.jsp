						...
						<div class="page-title">
							<h4>
								<i class="icon-arrow-left52 position-left"></i> <span
									class="text-semibold">참여기업관리</span> - 기업수정
							</h4>
						</div>
									...
									<div class="col-md-12">
										<fieldset>
											<%-- <input type="hidden" name="image1_ws"
												value="${companyRes.image1_ws }" /> <input type="hidden"
												name="image2_wl" value="${companyRes.image2_wl }" /> <input
												type="hidden" name="image2_ws"
												value="${companyRes.image2_ws }" /> <input type="hidden"
												name="image3_wl" value="${companyRes.image3_wl }" /> <input
												type="hidden" name="image3_ws"
												value="${companyRes.image3_ws }" /> <input type="hidden"
												name="image4_wl" value="${companyRes.image4_wl }" /> <input
												type="hidden" name="image4_ws"
												value="${companyRes.image4_ws }" /> <input type="hidden"
												name="image5_wl" value="${companyRes.image5_wl }" /> <input
												type="hidden" name="image5_ws"
												value="${companyRes.image5_ws }" /> <input type="hidden"
												name="image_cp" value="${companyRes.image_cp }" /> <input
												type="hidden" name="image_main"
												value="${companyRes.image_main }" /> <input type="hidden"
												name="image_list" value="${companyRes.image_list }" /> --%>
														...
														<div class="form-group">
															...
															<div class="media no-margin-top">
																...
																<div class="media-body">
																	...
																	<button type="button" class="btn btn-danger delImg">
																		삭제 <i class="icon-arrow-right14 position-right"></i>
																	</button>
											...
											<div class="row">
												...
												<div class="col-md-6">
													<div class="col-xs-6">
														<div class="form-group">
															<label>이미지4 (380 x 260)</label>
															<div class="media no-margin-top">
																<div class="media-left">
																	<c:choose>
																		<c:when test="${empty companyRes.image4_wl}">
																			<img src="/assets/images/placeholder.jpg"
																				style="width: 100px; height: 72px; border-radius: 2px;"
																				alt="">
																		</c:when>
																		<c:otherwise>
																			<img src="${companyRes.image4_wl}"
																				style="width: 100px; height: 72px; border-radius: 2px;"
																				alt="">
																		</c:otherwise>
																	</c:choose>
																...
																<div class="media-body">
																	<div class="uploader bg-warning">
																		<input type="file" class="file-styled"
																			name="file_image4_wl" /><span class="action"
																			style="-webkit-user-select: none;"><i
																			class="icon-googleplus5"></i></span>
																	</div>
																	<button type="button" class="btn btn-danger">
																	...
																	<input type="hidden" name="image4_wl"
																		value="${companyRes.image4_wl }" />
																</div>
															</div>
														</div>
													</div>
													<div class="col-xs-6">
														<div class="form-group">
															<label>이미지4 (52 x 52)</label>
															<div class="media no-margin-top">
																<div class="media-left">
																	<c:choose>
																		<c:when test="${empty companyRes.image4_ws}">
																			<img src="/assets/images/placeholder.jpg"
																				style="width: 100px; height: 72px; border-radius: 2px;"
																				alt="">
																		</c:when>
																		<c:otherwise>
																			<img src="${companyRes.image4_ws}"
																				style="width: 100px; height: 72px; border-radius: 2px;"
																				alt="">
																		</c:otherwise>
																	</c:choose>
																...
																<div class="media-body">
																	<div class="uploader bg-warning">
																		<input type="file" class="file-styled"
																			name="file_image4_ws" /><span class="action"
																			style="-webkit-user-select: none;"><i
																			class="icon-googleplus5"></i></span>
																	</div>
																	<button type="button" class="btn btn-danger">
																	...
																	<input type="hidden" name="image4_ws"
																		value="${companyRes.image4_ws }" />
											...
											<div class="row">
												<div class="col-md-6">
													<div class="col-xs-6">
														<div class="form-group">
															<label>이미지5 (380 x 260)</label>
															<div class="media no-margin-top">
																<div class="media-left">
																	<c:choose>
																		<c:when test="${empty companyRes.image5_wl}">
																			<img src="/assets/images/placeholder.jpg"
																				style="width: 100px; height: 72px; border-radius: 2px;"
																				alt="">
																		</c:when>
																		<c:otherwise>
																			<img src="${companyRes.image5_wl}"
																				style="width: 100px; height: 72px; border-radius: 2px;"
																				alt="">
																		</c:otherwise>
																	</c:choose>
																...
																<div class="media-body">
																	<div class="uploader bg-warning">
																		<input type="file" class="file-styled"
																			name="file_image5_wl" /><span class="action"
																			style="-webkit-user-select: none;"><i
																			class="icon-googleplus5"></i></span>
																	</div>
																	<button type="button" class="btn btn-danger">
																	...
																	<input type="hidden" name="image5_wl"
																		value="${companyRes.image5_wl }" />
													...
													<div class="col-xs-6">
														<div class="form-group">
															<label>이미지5 (52 x 52)</label>
															<div class="media no-margin-top">
																<div class="media-left">
																	<c:choose>
																		<c:when test="${empty companyRes.image5_ws}">
																			<img src="/assets/images/placeholder.jpg"
																				style="width: 100px; height: 72px; border-radius: 2px;"
																				alt="">
																		</c:when>
																		<c:otherwise>
																			<img src="${companyRes.image5_ws}"
																				style="width: 100px; height: 72px; border-radius: 2px;"
																				alt="">
																		</c:otherwise>
																	</c:choose>
																...
																<div class="media-body">
																	<div class="uploader bg-warning">
																		<input type="file" class="file-styled"
																			name="file_image5_ws" /><span class="action"
																			style="-webkit-user-select: none;"><i
																			class="icon-googleplus5"></i></span>
																	</div>
																	<button type="button" class="btn btn-danger">
																	...
																	<input type="hidden" name="image5_ws"
																		value="${companyRes.image5_ws }" />
											...
											<div class="">
												...
												<button type="button" class="btn btn-primary putBranch">
										...
										<div class="panel-body">
											...
											<div class="form-group">
												...
												<textarea rows="5" cols="5" class="form-control"
													placeholder="benefit" id="benefit_${rData.locale}"
													name="companyLocales[${rStatus.index}].benefit">${rData.benefit}</textarea>
											</div>
											<div class="form-group">
												<label>할인내용(${rData.locale}) :</label>
												<textarea rows="5" cols="5" class="form-control"
													placeholder="conditions" id="conditions_${rData.locale}"
													name="companyLocales[${rStatus.index}].conditions">${rData.conditions}</textarea>
											</div>
											<div class="form-group">
												<label>영업시간(${rData.locale}) :</label> <input type="text"
											...
											<div class="form-group">
												<label>휴무일(${rData.locale}) :</label> <input type="text"
													class="form-control" placeholder="rest_day"
													id="rest_day_${rData.locale}"
													name="companyLocales[${rStatus.index}].rest_day"
													value="${rData.rest_day}" />
											</div>
											<div class="form-group">
												<label>연락처(${rData.locale}) :</label> <input type="text"
											...
											<div class="form-group">
												<label>홈페이지(${rData.locale}) :</label> <input type="text"
													class="form-control" placeholder="homepage"
													id="homepage_${rData.locale}"
													name="companyLocales[${rStatus.index}].homepage"
													value="${rData.homepage}" />
											</div>
											<div class="form-group">
												<label>판매품목(${rData.locale}) :</label> <input type="text"
