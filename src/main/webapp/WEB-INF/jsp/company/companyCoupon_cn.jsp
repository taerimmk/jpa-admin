...
<body>
	...
	<div id="testCoupon"
		...
		<div style="color: #fff; padding: 10px; float: left; width: 200px;">
			<p style="font-size: 14px; color: #ffffff;">优惠</p>
		...
		<div style="padding: 10px; left: 200px; float: left; width: 750px;">
			...
			<p style="font-size: 14px; color: #000000;">- 住址 :
			...
			<p style="font-size: 14px; color: #000000;">- 网站 :
				${companyRes.companyLocales[0].homepage}</p>
			<p style="font-size: 14px; color: #000000;">- 连络电话 :
				${companyRes.companyLocales[0].phone_number}</p>
			<p style="font-size: 14px; color: #000000;">- 营业时间 :
				${companyRes.companyLocales[0].working_hour}</p>
			<p style="font-size: 14px; color: #000000;">- 休息日 :
