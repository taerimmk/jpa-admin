...
<body>
	...
	<div id="testCoupon"
		...
		<div style="padding: 10px; left: 200px; float: left; width: 750px;">
			...
			<p style="font-size: 14px; color: #000000;">- 주소 :
			...
			<p style="font-size: 14px; color: #000000;">- 홈페이지 :
				${companyRes.companyLocales[0].homepage}</p>
			<p style="font-size: 14px; color: #000000;">- 전화 :
				${companyRes.companyLocales[0].phone_number}</p>
			<p style="font-size: 14px; color: #000000;">- 영업시간 :
				${companyRes.companyLocales[0].working_hour}</p>
			<p style="font-size: 14px; color: #000000;">- 휴무일 :
