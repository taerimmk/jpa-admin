...
<body>
	...
	<div id="testCoupon"
		...
		<div style="color: #fff; padding: 10px; float: left; width: 200px;">
			<p style="font-size: 14px; color: #ffffff;">Offer</p>
		...
		<div style="padding: 10px; left: 200px; float: left; width: 750px;">
			...
			<p style="font-size: 14px; color: #000000;">- Address :
			...
			<p style="font-size: 14px; color: #000000;">- Website :
				${companyRes.companyLocales[0].homepage}</p>
			<p style="font-size: 14px; color: #000000;">- Contacts :
				${companyRes.companyLocales[0].phone_number}</p>
			<p style="font-size: 14px; color: #000000;">- Opening Hours :
				${companyRes.companyLocales[0].working_hour}</p>
			<p style="font-size: 14px; color: #000000;">- Closed :
