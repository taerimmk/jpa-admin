...
<div class="navbar navbar-inverse">
	<div class="navbar-header">
		<a class="navbar-brand" href="/">
			<i class="icon-chess-king"></i>&nbsp;&nbsp;&nbsp;Korea Grand Sale&nbsp;&nbsp;&nbsp;<i class="icon-chess-king"></i>
			<!-- <img
			src="/assets/images/logo_light.png" alt=""> -->
		</a>
		...
		<ul class="nav navbar-nav navbar-right">
			<li class="dropdown dropdown-user"><a class="dropdown-toggle"
				data-toggle="dropdown"> <img
					src="/assets/images/logo_main_top.png" alt=""> <span>Korea
						Grand Sale</span> <i class="caret"></i>
			</a>
