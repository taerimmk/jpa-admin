 ...
 */
@Entity
@Table(name = "upcomingeventsbanner")
@DynamicUpdate
public class UpcomingEventsBanner extends BaseEntity {
	...
	public String toString() {
		return "UpcomingEventsBanner [id=" + id + ", bannername=" + bannername + ", created_at=" + created_at + ", updated_at="
