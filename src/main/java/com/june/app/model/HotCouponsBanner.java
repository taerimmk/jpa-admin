 ...
 */
@Entity
@Table(name = "hotcouponsbanner")
@DynamicUpdate
public class HotCouponsBanner extends BaseEntity {
	...
	// 배너 상단 설명
	@Column(name = "banner_msg_ko", columnDefinition = "VARCHAR(600)")
	@NotEmpty
	private String banner_msg_ko;
	@Column(name = "banner_msg_en", columnDefinition = "VARCHAR(600)")
	@NotEmpty
	private String banner_msg_en;
	@Column(name = "banner_msg_jp", columnDefinition = "VARCHAR(600)")
	@NotEmpty
	private String banner_msg_jp;
	@Column(name = "banner_msg_cn", columnDefinition = "VARCHAR(600)")
	@NotEmpty
	private String banner_msg_cn;
	@Column(name = "banner_msg_tw", columnDefinition = "VARCHAR(600)")
	@NotEmpty
	private String banner_msg_tw;
	...
	public String getBanner_msg_ko() {
		return banner_msg_ko;
	}

	public void setBanner_msg_ko(String banner_msg_ko) {
		this.banner_msg_ko = banner_msg_ko;
	}

	public String getBanner_msg_en() {
		return banner_msg_en;
	}

	public void setBanner_msg_en(String banner_msg_en) {
		this.banner_msg_en = banner_msg_en;
	}

	public String getBanner_msg_jp() {
		return banner_msg_jp;
	}

	public void setBanner_msg_jp(String banner_msg_jp) {
		this.banner_msg_jp = banner_msg_jp;
	}

	public String getBanner_msg_cn() {
		return banner_msg_cn;
	}

	public void setBanner_msg_cn(String banner_msg_cn) {
		this.banner_msg_cn = banner_msg_cn;
	}

	public String getBanner_msg_tw() {
		return banner_msg_tw;
	}

	public void setBanner_msg_tw(String banner_msg_tw) {
		this.banner_msg_tw = banner_msg_tw;
	}
	...
	public String toString() {
		return "HotCouponsBanner [id=" + id + ", bannername=" + bannername + ", banner_msg_ko=" + banner_msg_ko
				+ ", banner_msg_en=" + banner_msg_en + ", banner_msg_jp=" + banner_msg_jp + ", banner_msg_cn="
				+ banner_msg_cn + ", banner_msg_tw=" + banner_msg_tw + ", created_at=" + created_at + ", updated_at="
